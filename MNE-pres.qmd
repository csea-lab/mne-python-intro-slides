...
![](IMG-1945.jpg){.absolute top=50 right=50  height="250"}
...
![](IMG-1945.jpg){.absolute top=50 right=50  height="250"}
![](IMG-2468_c.jpg){.absolute bottom=0 right=50  height="250"}
...
:::
::: {.fragment}
![](cats_boxes_giphy.gif){.absolute bottom=0 left=0  height="250"}
:::
:::
...
-   MNE-Python data objects as `NumPy` arrays facilitates:
    ...
    -   Moving data into one of [scikit-learn's](https://scikit-learn.org/stable/) machine learning pipelines
...
::: footer
Learn more: [scikit-learn](https://scikit-learn.org/stable/)
:::
